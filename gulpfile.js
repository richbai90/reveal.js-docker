...
gulp.task("fontawesome", () =>
  gulp
    ...
    .pipe(gulp.dest("./dist/lib/fontawesome-free/")),
);

gulp.task("twemoji", () =>
  gulp
    .src(["./node_modules/twemoji/dist/twemoji.min.js"])
    .pipe(gulp.dest("./dist/lib/twemoji")),
);

gulp.task(
  "build",
  gulp.parallel("js", "css", "plugins", "fontawesome", "twemoji"),
);
